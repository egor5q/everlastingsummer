...
def eveninggames():
    ...
    if x=='cards':
        ...
        time.sleep(1)
        electronic.send_chat_action(-1001351496983,'typing') 
        t=threading.Timer(6, sendmes, args=[electronic, 'Итак. Правила игры просты: надо выиграть, собрав на руке более сильную '+\
        ...
        time.sleep(7)
        electronic.send_chat_action(-1001351496983,'typing') 
        t=threading.Timer(3, sendmes, args=[electronic, 'Что смешного? Ладно, неважно. Все поняли правила? Отлично! Для '+\
